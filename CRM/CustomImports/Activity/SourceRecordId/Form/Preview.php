 ...
 */
class CRM_CustomImports_Activity_SourceRecordId_Form_Preview extends CRM_Activity_Import_Form_Preview
{
    /**
    ...
    public function postProcess()
    {
        ...
        $parser = new CRM_CustomImports_Activity_SourceRecordId_Parser($mapperKeys);
        ...
        if (is_array($errors)) {
            ...
            $urlParams = 'type=' . CRM_Import_Parser::ERROR . '&parser=CRM_CustomImports_Activity_SourceRecordId_Parser';
            $this->set('downloadErrorRecordsUrl', CRM_Utils_System::url('civicrm/export', $urlParams));
            $urlParams = 'type=' . CRM_Import_Parser::CONFLICT . '&parser=CRM_CustomImports_Activity_SourceRecordId_Parser';
            $this->set('downloadConflictRecordsUrl', CRM_Utils_System::url('civicrm/export', $urlParams));
            $urlParams = 'type=' . CRM_Import_Parser::NO_MATCH . '&parser=CRM_CustomImports_Activity_SourceRecordId_Parser';
