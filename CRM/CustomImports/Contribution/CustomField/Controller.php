 ...
 */
class CRM_CustomImports_Contribution_CustomField_Controller extends CRM_Core_Controller
{
   ...
   */
    public function __construct($title = null, $action = CRM_Core_Action::NONE, $modal = true)
    {
        ...
        $this->_stateMachine = new CRM_CustomImports_Contribution_CustomField_StateMachine($this, $action);
