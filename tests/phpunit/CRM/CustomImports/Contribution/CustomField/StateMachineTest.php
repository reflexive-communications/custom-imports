 ...
 * @group headless
 */
class CRM_CustomImports_Contribution_CustomField_StateMachineTest extends \PHPUnit\Framework\TestCase implements HeadlessInterface, HookInterface, TransactionalInterface
{
