 ...
 * @group headless
 */
class CRM_CustomImports_Activity_SourceRecordId_Form_PreviewTest extends CRM_CustomImports_HeadlessBase
{
    /**
    ...
    public function testPostProcess()
    {
        ...
        $form = new CRM_CustomImports_Activity_SourceRecordId_Form_Preview();
